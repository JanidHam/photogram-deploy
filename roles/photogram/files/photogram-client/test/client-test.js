...
const photogram = require('../')
const fixtures = require('./fixtures')

let options = {
  endpoints: {
    pictures: 'http://photogram.test/picture',
    users: 'http://pohotogram.test/user',
    auth: 'http://pohotogram.test/auth'
  }
}

test.beforeEach(t => {
  t.context.client = photogram.createClient(options)
})
